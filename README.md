...
Project Overview
The Azure Cost Visibility Dashboard is an enterprise cloud cost management solution that provides real-time visibility into Azure spending, AI-powered cost analysis, and automated resource optimization. Built with React, Node.js, Azure Functions, and Azure Kubernetes Service (AKS), the application securely retrieves Azure Cost Management data using Managed Identity and RBAC. It enables finance, engineering, and cloud operations teams to monitor cloud costs, identify optimization opportunities, and improve governance across Azure environments.
---
